...
def build_config(
    ...
    config: Dict[str, Any] = {
        ...
        "sftp": {
            ...
            "host": sftp_host_override or SFTP_HOST,
            "port": sftp_port_override if sftp_port_override is not None else SFTP_PORT,
            "username": sftp_username_override or SFTP_USERNAME,
            "password": sftp_password_override or SFTP_PASSWORD,
            "password_encrypted": False,
            "base_path": sftp_base_path_override or SFTP_BASE_PATH,
        },
